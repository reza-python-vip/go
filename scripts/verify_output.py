...
def verify_subscription_files(plain_path, base64_path):
    ...
    if plain_content_normalized == decoded_content_normalized:
        ...
        print("Fatal Error: Mismatch found between decoded base64 and plain-text content.")
        print("Self-Verification Gate has FAILED. Stopping pipeline to prevent corrupted deployment.")
